...
<html lang="zxx">
<head>
<title>Prezzie an Ecommerce Online Shopping Category Bootstrap Responsive Website Template | Gallery :: w3layouts</title>
<!-- custom-theme -->
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Gallery</h2>
...
<div class="gallery" id="gallery">
	<div class="container">
		<div class="heading-setion-w3ls">
						<h3 class="title-w3layouts">Gift Gallery <i class="fa fa-bell-o" aria-hidden="true"></i><i class="fa fa-bell" aria-hidden="true"></i></h3>
					</div>
		<div class="agileinfo_work_grids">
				<div class="col-md-4 w3_agile_work_grid gallery1">
					<div class="wthree_work_grid1">
						<a href="images/g1.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
					...
					<div class="wthree_work_grid1">
						<a href="images/g2.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
					...
					<div class="wthree_work_grid1">
						<a href="images/g3.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
				...
				<div class="col-md-4 w3_agile_work_grid">
					<div class="wthree_work_grid1">
						<a href="images/g4.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
					...
					<div class="wthree_work_grid1">
						<a href="images/g5.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
					...
					<div class="wthree_work_grid1">
						<a href="images/g6.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
				...
				<div class="col-md-4 w3_agile_work_grid">
					<div class="wthree_work_grid1">
						<a href="images/g7.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
					...
					<div class="wthree_work_grid1">
						<a href="images/g8.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
					...
					<div class="wthree_work_grid1">
						<a href="images/g9.jpg" class="b-link-stripe b-animate-go  swipebox" title="Prezzie">
							<div class="agile_work_grid w3_agileits_sub_work">
