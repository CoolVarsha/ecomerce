...
<html lang="zxx">
<head>
<title>Prezzie an Ecommerce Online Shopping Category Bootstrap Responsive Website Template | Short Codes :: w3layouts</title>
<!-- custom-theme -->
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Short Codes</h2>
...
<!--typography-page -->
	<div class="typo">
		<div class="container">
			<h3 class="agileits-icons-title">Short Codes</h3>
