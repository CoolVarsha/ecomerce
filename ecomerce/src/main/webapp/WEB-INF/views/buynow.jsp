		...
		<div class="center-container inner-container">
			<div class="w3_agile_header">
						<div class="w3_agileits_logo">
								<h1><a href="index.html">prezzie<span>Life is a gift</span></a></h1>
							</div>
							<div class="w3_menu">
								...
								<nav class="navbar navbar-default">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											...
											<li><a href="buynow.html" class="active">Buy</a></li>
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Buy Now</h2>
...
<div class="buy-now">
		...
		<div class="heading-setion-w3ls">
			<h3 class="title-w3layouts">Select Your Favourite Gift <i class="fa fa-bell-o" aria-hidden="true"></i><i class="fa fa-bell" aria-hidden="true"></i></h3>
		</div>
				<div class="team-grids">
					...
					<div class="details-top-w3ls">
						<div class="col-md-3 team-grid">
							...
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d1.jpg" alt="img"><span>#001</span></div>
								<div class="info">
									<h3>$95.00</h3>
									<ul>
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d2.jpg" alt="img"><p>Sale</p><span>#002</span></div>
								<div class="info">
									<h3>$80.00<span>$100.00</span></h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
										<li class="cary-li-w3-agileits">
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d3.jpg" alt="img"><span>#003</span></div>
								<div class="info">
									<h3>$100.00</h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d4.jpg" alt="img"><p>Sale</p><span>#004</span></div>
								<div class="info">
									<h3>$90.00<span>$100.00</span></h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
										<li class="cary-li-w3-agileits">
					...
					<div class="details-mid-w3ls">
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d5.jpg" alt="img"><p>Sale</p><span>#005</span></div>
								<div class="info">
									<h3>$75.00<span>$100.00</span></h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
										<li class="cary-li-w3-agileits">
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d4.jpg" alt="img"><span>#006</span></div>
								<div class="info">
									<h3>$170.00</h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d6.jpg" alt="img"><p>Sale</p><span>#007</span></div>
								<div class="info">
									<h3>$100.00<span>$200.00</span></h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
										<li class="cary-li-w3-agileits">
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d2.jpg" alt="img"><span>#008</span></div>
								<div class="info">
									<h3>$50.00</h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d7.jpg" alt="img"><span>#009</span></div>
								<div class="info">
									<h3>$300.00</h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d8.jpg" alt="img"><p>Sale</p><span>#010</span></div>
								<div class="info">
									<h3>$350.00<span>$450.00</span></h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
										<li class="cary-li-w3-agileits">
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d9.jpg" alt="img"><span>#011</span></div>
								<div class="info">
									<h3>$300.00</h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
						...
						<div class="col-md-3 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="images/d10.jpg" alt="img"><p>Sale</p><span>#012</span></div>
								<div class="info">
									<h3>$300.00<span>$500.00</span></h3>
									<ul>
										<li><a href="#"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
										<li class="cary-li-w3-agileits">
